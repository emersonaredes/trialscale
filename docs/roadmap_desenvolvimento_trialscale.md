...
## Apêndice A — Rascunho de CLAUDE.md (colar na raiz do repo e ajustar)
...
## Stack
[preencher conforme decisão: ex. Node+Express+Prisma+MySQL / React+Vite /
Tailwind+shadcn/ui / TypeScript estrito / Vitest+Playwright]

## Comandos
[preencher: dev, build, test, lint, migrate]
...
## Apêndice B — Rascunho de constitution.md
...
*Fim do roadmap de desenvolvimento v1.*
